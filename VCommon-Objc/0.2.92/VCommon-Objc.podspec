...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'ssh://git-codecommit.eu-west-1.amazonaws.com/v1/repos/VCommon-ObjectiveC', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'VCommon-Objc/**/*.{h,m}'

#   s.resource_bundles = {
#     'VCommon-Objc' => ['VCommon-Objc/UI/User/TableCells/*.xib', 'VCommon-Objc/Utils/**/*.xib']
#   }

  # s.public_header_files = 'Pod/Classes/**/*.h'
  # s.frameworks = 'UIKit', 'MapKit'
# s.resources = ['VCommon-Objc/UI/User/TableCells/*.xib', 'VCommon-Objc/Utils/**/*.xib']
